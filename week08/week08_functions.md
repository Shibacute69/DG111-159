...
**คำตอบ:Clamp ทำหน้าที่จำกัดValue ไม่ให้เกินแต่ไม่ได้เขียนทับให้ใน main**

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ:เพราะ** Result **ถูกประกาศอยู่ใน** local scope**จึงเข้าถึงได้เฉพาะภายใน** lerp **เท่านั้น แม้ว่า** **จะอยู่ในไฟล์เดียวกันก็ตาม**
...
**คำตอบ:program จะก็อปปี้แค่ตัวเลข 1 ส่งไปในฟังก์ชัน ไม่ได้ส่งตัวแปรไปจริงๆ**
...
**คำตอบ:เพราะcurrent ดึงค่ามาจาก score ทำให้scoreไม่ได้มีการเปลี่ยนแปลงค่าใดๆ**
